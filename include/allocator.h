...
class IAllocator {
 public:
  virtual void Allocate(void **mem, size_t size, bool recycle = false) = 0;
  virtual void AllocateAligned(void **mem, size_t size, uint32_t alignment, bool recycle = false) = 0;
